...
//
//            pstmt.setObject(2, e.getPassword() + SALT);
//
//            pstmt.setObject(3, e.getLastAcess(), java.sql.Types.DATE);
//
//            pstmt.setObject(4, e.getEnabled());
//
//            if (e.getId() != null) {
    ...
    public void composeSaveOrUpdateStatement(PreparedStatement pstmt, Credential e){
        try {
            if(e.getId() != null && e.getId() < 0) {
                ...
                pstmt.setObject(3, e.getLastAccess(), java.sql.Types.DATE);
